package ke.co.coverapp.coverapp.application;
...
public class MyApplication extends Application {
    ...
    private static CoverAppDB mDatabase;

    public synchronized static CoverAppDB getWritableDatabase() {
        if (mDatabase == null) {
            mDatabase = new CoverAppDB(getAppContext());
        }
        return mDatabase;
    }
